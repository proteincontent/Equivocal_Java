      ...
      >
        ...
        <div className="flex flex-col gap-2 p-3 pb-0">
          ...
          <div
            className={cn(
              "flex items-center",
              collapsed ? "justify-center flex-col gap-4" : "justify-between px-1",
            )}
          >
            <motion.button
              onClick={() => {
            ...
            >
              ...
              <AnimatePresence>
                {!collapsed && (
                  ...
                  >
                    <span className="text-sm font-serif font-medium tracking-wide text-foreground leading-none mb-1">
                      智法顾问
                    </span>
                    <span className="text-[10px] text-[#2563EB]/80 uppercase tracking-widest leading-none">
                      法律 AI
                    </span>
                  </motion.div>
                )}
                          ...
                          {!collapsed && editingSessionId !== session.id && (
                            ...
                            >
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent
                                  align="end"
                                  className="w-32 bg-popover border-border text-popover-foreground backdrop-blur-xl shadow-xl"
                                >
                                  <DropdownMenuItem
                                    onClick={() => {
