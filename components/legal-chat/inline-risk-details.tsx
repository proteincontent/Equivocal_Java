...
export function InlineRiskDetails({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "overflow-hidden rounded-lg border bg-card/95 backdrop-blur shadow-sm select-text cursor-auto",
        className,
      )}
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-muted-foreground/60 font-normal">按 Esc 收起</span>
        </div>
      </div>
