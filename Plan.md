...
## 湖州学院_开题答辩_Beamer（AI-Native Minimal · 归档/可回退）（2026-01-12）
...
## （归档）湖州学院_开题答辩_Beamer（Apple Light · LangGraph 法律智能体）改版计划（2026-01-11）
...
## （归档）湖州学院_开题答辩_Beamer（LuaLaTeX + metropolis）修复计划（2026-01-11）
